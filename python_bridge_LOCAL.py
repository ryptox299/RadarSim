...
async def process_data(sim_ip, sim_port, cpp_ip, cpp_port):
    while True:  # Retry loop
        try:
            # Attempt to connect to the radar simulation server
            print(f"Trying to connect to simulation server at {sim_ip}:{sim_port}...")
            ...
            print(f"Failed to connect to simulation server: {e}")
...
if __name__ == "__main__":
    SIM_IP = "127.0.0.1"  # Radar simulation server IP
